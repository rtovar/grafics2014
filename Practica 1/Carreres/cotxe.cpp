    ...
    if (!fp)
    {
        ...
        while (true)
        {
            ...
            if (!strcmp (first_word, "v"))
            {
                ...
                lObjecte->vertexs.push_back(point4(x, y, z, 1));
                vindexAct++;
            ...
            // added
                ...
                if (!strcmp (first_word, "Roda_Dreta_Posterior_04")) {
                    lObjecte = &roda_rr;
                } else if (!strcmp (first_word, "Roda_Dreta_Davantera_03")) {
                    lObjecte = &roda_fr;
                } else if (!strcmp (first_word, "Roda_Esquerra_Davantera_02")) {
                    lObjecte = &roda_fl;
                } else if (!strcmp (first_word, "Roda_Esquerra_Posterior_Untitled")) {
                    lObjecte = &roda_rl;
                } else if (!strcmp (first_word, "Carrosseria_00")) {
                    lObjecte = &carrosseria;
                }
            }
            // fadded
            else {
